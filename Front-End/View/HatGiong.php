...
<div class="ct">
    ...
    <div class="container mt-4 mb-3">
        ...
        <div class="sec-title centered ">
            <h1 class="text-success mb-4">Seeds<h1>
        </div>
        <div class="row mb-2 ">
            <!-- Start PHP code -->
            <?php
    ...
    <div class="container mt-3 mb-5">
        <h3 class="text-success mb-5" style="color:chocolate;">You can read the books below to be more sure about gardening!</h3>
