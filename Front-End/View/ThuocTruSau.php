<body>
    ...
    $sql = "SELECT * FROM post WHERE post_category_id = 7 AND status =1 LIMIT $start, $limit";
    ...
    <div>
        ...
        <div class="container mt-4 mb-3">
            ...
            <div class="sec-title centered ">
                <h1 class="text-success mb-4">Pesticides<h1>
            </div>
            <div class="row mb-2 ">
                <!-- Start PHP code -->
                <?php
        ...
        <div class="pagination">
            ...
            if ($total_page > 1) {
                ...
                if ($current_page > 1 && $total_page > 1) {
                    echo '<a href="ThuocTruSau.php?page=' . ($current_page - 1) . '">Prev</a>';
                }
                ...
                for ($i = 1; $i <= $total_page; $i++) {
                    ...
                    if ($i == $current_page) {
                        ...
                        echo '<a href="ThuocTruSau.php?page=' . $i . '">' . $i . '</a>';
                    }
                }
                ...
                if ($current_page < $total_page && $total_page > 1) {
                    echo '<a href="ThuocTruSau.php?page=' . ($current_page + 1) . '">Next</a>';
                }
            }
            ?>
        </div>
